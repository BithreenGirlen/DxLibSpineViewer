...
public:
	...
	virtual void mixAnimations(const char* fadeOutAnimationName, const char* fadeInAnimationName, float mixTime) = 0;
	virtual void clearMixedAnimation() = 0;
	...
	/* Functions dependent on data type of DxLib */
